...
//	aHash, _ := common.HexToHash("a")
//	bHash, _ := common.HexToHash("b")
//	cHash, _ := common.HexToHash("c")
//
//	var (
//		hashrate = []hexutil.Uint64{100, 200, 300}
//		expect   uint64
//
//		ids      = []common.Hash{aHash, bHash, cHash}
//	)
//	ethash := NewTester(nil, false)
//	defer ethash.Close()
//
...
//
//	aHash, _ := common.HexToHash("a")
//	if res := api.SubmitHashRate(hexutil.Uint64(100), aHash); res {
